...
<body>
	...
	<div
		class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
		<h1 class="font-weight-bold text-uppercase mb-3">ORDER LIST</h1>
		<div class="d-inline-flex">
			<p>
				<span style="color:#000; font-weight:bold;">01 장바구니 >&nbsp;</span>
			</p>
			<p style="color:#bdbdbd; font-weight:bold;">02 주문결제 > 03 주문완료</p>
		</div>
	</div>
	...
	<div class="container-fluid" style="margin-bottom:70px;">
		<div class="row px-xl-5">
			<div class="col-lg-8 table-responsive">
											...
											<tr>
												...
												<td class="align-middle">
													<div class="input-group quantity mx-auto"
														...
														<input type="text" class="form-control form-control-sm text-center itemCount"
				...
				<div class="cart-tfoot text-right selectNext">
					<span class="cart-price">총 상품금액</span>
					<span class="cart-won"><fmt:formatNumber pattern="#,###원" value="${totalPrice}" /></span>
				</div>

				<c:if test="${not empty itemList}">
					<!-- itemList가 비어있지 않을 때만 버튼을 보여줌 -->
					<button type="button" class="btn btn-dark" id="allDeleteButton">전체상품삭제</button>
					<button type="button" class="btn btn-primary" onclick="deleteSelectedItems()">선택상품삭제</button>
				</c:if>
			</div>
			...
			<button type="button" onclick="placeOrder()" class="btn btn-dark my-3 py-3" style="width:500px">전체상품 주문하기</button>
		</div>
	</div>
	<!-- Cart End -->
